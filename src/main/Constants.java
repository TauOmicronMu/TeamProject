...
public class Constants {
    ...
    public static final double INV_GAME_SPEED = 50;
    public static final double TIME_STEP_COEFFICIENT = 1/ INV_GAME_SPEED;
    ...
    public static final int SRVR_MS_PER_UPDT = 50;
}
