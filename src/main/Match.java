...
public class Match implements Runnable {
    ...
    public void run() {
        ...
        GameState playerOneGameState = new GameState(Constants.WINDOW_WIDTH, Constants.WINDOW_HEIGHT, 2);
        playerOneGameState.setSeed(seed);
        GameState playerTwoGameState = new GameState(Constants.WINDOW_WIDTH, Constants.WINDOW_HEIGHT, 2);
