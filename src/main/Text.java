...
public class Text implements Serializable{
	...
	private void drawA(float scale, float startX, float y)
	{
		...
		/*!1-2*/
        GL11.glVertex2f(scale * (startX - 0.55f), scale * (y-0.7f));
        /*1-!2*/
        GL11.glVertex2f(scale * (startX - 0.55f), scale * (y -1.0f));
        /*!2-3*/
        GL11.glVertex2f(scale * (startX - 0.55f), scale * (y -1.0f));
        /*2-!3*/
        GL11.glVertex2f(scale * (startX-0.05f), scale * (y -1.0f));
        /*!3-4*/
        GL11.glVertex2f(scale * (startX-0.05f), scale * (y -1.0f));
        /*3-!4*/
        GL11.glVertex2f(scale * (startX-0.05f), scale * (y-0.7f));
        /*!4-1*/
        GL11.glVertex2f(scale * (startX-0.05f), scale * (y-0.7f));
        /*4-!1*/
        GL11.glVertex2f(scale * (startX - 0.55f), scale * (y-0.7f));
        ...
        GL11.glVertex2f(scale * (startX-0.05f), scale * (y-0.7f));
        /*4-!5*/
        GL11.glVertex2f(scale * (startX-0.05f), (scale) * (y - 0.4f));
        /*!5-6*/
        GL11.glVertex2f(scale * (startX-0.05f), (scale) * (y - 0.4f));
        /*5-!6*/
        GL11.glVertex2f(scale * (startX - 0.55f), scale * (y - 0.4f));
	}
