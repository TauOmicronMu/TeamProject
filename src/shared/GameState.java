 ...
 * provides shared.utility methods for generating these positions at the
        ...
        for (int i = 0; i < items.length; i++) {
                if (items[i].getY() >= windowHeight) {
                    ...
                    switch (random.nextInt(5)) {
                        case 0:
                            items[i]=new GravDown( -1000 + y - random.nextInt(500), 1);
                            break;
                        case 1:
                            items[i]=new GravUp(  - 1000 + y - random.nextInt(500), 2);
                            break;
                        case 2:
                            items[i]=new FlyUpPower(  - 1000 + y - random.nextInt(500), 3);
                            break;
                        case 3:
                            items[i]=new PointsItem(-1000 + y - random.nextInt(500), 4);
                            break;
                        case 4:
...
//        }
    ...
    /**
     * Populates the list of items in this shared.GameState with a set of
    ...
    public void generateItems() {
        ...
        for (int i = 0; i < items.length; i++) {
            switch (random.nextInt(5)) {
                case 0:
                    items[i]=new GravDown(- i * 500 + random.nextInt(500), 1);
                    break;
                case 1:
                    items[i]=new GravUp(- i * 500 + random.nextInt(500), 2);
                    break;
                case 2:
                    items[i]=new FlyUpPower(-i * 500 + random.nextInt(500), 3);
                    break;
                case 3:
                    items[i]=new PointsItem(-i * 500 + random.nextInt(500), 4);
                    break;
                case 4:
                    items[i]=new MakeOpponentPlatformDissapearPowerUp(-i * 500 + random.nextInt(500), 5);
                    break;
            }
        }
    }
