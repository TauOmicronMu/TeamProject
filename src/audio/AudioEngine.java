...
public class AudioEngine {
    ...
    public static final int BLOP = AUDIO_ENGINE.createTrack("audio/blopalop.wav");
    public static final int WHOOSH = AUDIO_ENGINE.createTrack("audio/hswoosh.wav");
    public static final int GRAVDOWN = AUDIO_ENGINE.createTrack("audio/gravdown.wav");
    public static final int GRAVUP = AUDIO_ENGINE.createTrack("audio/gravup.wav");
    public static final int POINTS = AUDIO_ENGINE.createTrack("audio/points.wav");
    public static final int DELETE_PLATFORM = AUDIO_ENGINE.createTrack("audio/platform.wav");
