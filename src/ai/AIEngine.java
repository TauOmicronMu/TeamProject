...
public class AIEngine {
	 ...
	 * @throws IOException
	 */
	public AIEngine() throws IOException{
		...
		int maxWidth = Constants.WINDOW_WIDTH;
		int maxHeight = Constants.WINDOW_HEIGHT;
 ...
 */
	...
	public static void main(String... args) {
		try {
			// Generate and store all data for the AI.
			new AIEngine();
		} catch (IOException e) {
			System.out.println("[ERROR] AIEngine.main : IOException when creating AI Engine.");
		}
	}
}
