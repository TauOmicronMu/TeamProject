...
import object.Ball;
import object.platform.NormalPlatform;
...
public class GameStateTest {
    ...
    public void updatePhysics() throws Exception {
        ...
        gameState.setSeed(2);
        gameState.items[0]  = new GravDown(800 , 1);
        gameState.items[1]  = new FlyUpPower(900, 3);
        gameState.items[2]  = new PointsItem(1000, 3);
        gameState.items[3]  = new MakeOpponentPlatformDissapearPowerUp(1100, 3);
        gameState.items[4]  = new GravUp( 1200, 2);
    ...
    public void getItems() throws Exception {
        gameState.setSeed(2);
        gameState.items[0]  = new GravDown(-500 , 1);
        gameState.items[1]  = new FlyUpPower(-700, 3);
        gameState.items[2]  = new GravUp( -900, 2);
    ...
    public void getHighestItem() throws Exception {
        gameState.items[0]  = new GravDown(-500 , 1);
        gameState.items[1]  = new FlyUpPower(-700, 3);
        gameState.items[2]  = new PointsItem(-700, 3);
        gameState.items[3]  = new MakeOpponentPlatformDissapearPowerUp(-700, 3);
        gameState.items[4]  = new GravUp( -900, 2);
